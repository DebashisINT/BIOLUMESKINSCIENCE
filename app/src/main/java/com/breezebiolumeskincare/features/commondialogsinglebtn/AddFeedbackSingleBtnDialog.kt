package com.breezebiolumeskincare.features.commondialogsinglebtn
...
import com.breezebiolumeskincare.app.domain.ShopVisitCompetetorModelEntity
import com.breezebiolumeskincare.app.domain.VisitRemarksEntity
...
import com.breezebiolumeskincare.features.addshop.presentation.ProspectListDialog
import com.breezebiolumeskincare.features.dashboard.presentation.DashboardActivity
import com.breezebiolumeskincare.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezebiolumeskincare.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezebiolumeskincare/files", "recorded_audio${System.currentTimeMillis()}.mp3")
