package com.breezebiolumeskincare.features.logoutsync.presentation
...
import com.breezebiolumeskincare.app.AppDatabase
...
import com.breezebiolumeskincare.app.utils.AppUtils
import com.breezebiolumeskincare.app.utils.Toaster
import com.breezebiolumeskincare.base.BaseResponse
import com.breezebiolumeskincare.base.presentation.BaseActivity
import com.breezebiolumeskincare.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezebiolumeskincare.features.billing.api.AddBillingRepoProvider
import com.breezebiolumeskincare.features.billing.model.AddBillingInputParamsModel
...
import com.breezebiolumeskincare.features.dashboard.presentation.ReasonDialog
...
import com.breezebiolumeskincare.features.document.model.AddEditDocumentInputParams
import com.breezebiolumeskincare.features.document.model.DocumentAttachmentModel
...
import com.breezebiolumeskincare.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.breezebiolumeskincare.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezebiolumeskincare.features.orderhistory.model.*
...
import com.breezebiolumeskincare.features.quotation.model.AddQuotInputModel
import com.breezebiolumeskincare.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezebiolumeskincare.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezebiolumeskincare.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
import com.breezebiolumeskincare.features.stock.api.StockRepositoryProvider
import com.breezebiolumeskincare.features.stock.model.AddStockInputParamsModel
import com.breezebiolumeskincare.features.stockAddCurrentStock.AddShopStockFragment
import com.breezebiolumeskincare.features.stockAddCurrentStock.ShopAddCurrentStockList
import com.breezebiolumeskincare.features.stockAddCurrentStock.ShopAddCurrentStockRequest
...
import com.breezebiolumeskincare.features.stockCompetetorStock.ShopAddCompetetorStockRequest
...
import com.breezebiolumeskincare.features.timesheet.model.AddTimeSheetInputModel
import com.breezebiolumeskincare.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezebiolumeskincare.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezebiolumeskincare.features.viewAllOrder.model.AddOrderInputProductList
import com.breezebiolumeskincare.mappackage.SendBrod
import com.breezebiolumeskincare.widgets.AppCustomTextView
import com.breezebiolumeskincare.MonitorService
import com.breezebiolumeskincare.MySingleton
import com.breezebiolumeskincare.app.AlarmReceiver
...
import com.breezebiolumeskincare.features.addshop.presentation.ShopExtraContactReq
...
import com.breezebiolumeskincare.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezebiolumeskincare.features.login.model.GetConcurrentUserResponse
import com.breezebiolumeskincare.features.login.model.WhatsappApiData
import com.breezebiolumeskincare.features.orderITC.SyncDeleteOppt
import com.breezebiolumeskincare.features.orderITC.SyncDeleteOpptL
import com.breezebiolumeskincare.features.orderITC.SyncEditOppt
import com.breezebiolumeskincare.features.orderITC.SyncOppt
import com.breezebiolumeskincare.features.orderITC.SyncOpptProductL
import com.breezebiolumeskincare.features.orderITC.SyncOrd
import com.breezebiolumeskincare.features.orderITC.SyncOrdProductL
import com.breezebiolumeskincare.features.performance.model.Gps_status_list
import com.breezebiolumeskincare.features.performance.model.UpdateGpsInputListParamsModel
import com.breezebiolumeskincare.features.returnsOrder.ReturnProductList
import com.breezebiolumeskincare.features.returnsOrder.ReturnRequest
import com.breezebiolumeskincare.features.viewAllOrder.model.NewOrderSaveApiModel
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezebiolumeskincare/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiolumeskincarelogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiolumeskincarelogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezebiolumeskincarelogsample/log.zip").path);
