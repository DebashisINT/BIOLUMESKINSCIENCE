package com.breezebiolumeskincare.features.nearbyshops.presentation
...
import com.breezebiolumeskincare.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezebiolumeskincare.app.utils.FTStorageUtils
import com.breezebiolumeskincare.app.utils.NotificationUtils
...
import com.breezebiolumeskincare.features.addshop.model.AssignedToShopListResponseModel
import com.breezebiolumeskincare.features.addshop.model.QuestionSubmit
import com.breezebiolumeskincare.features.addshop.model.UpdateAddrReq
import com.breezebiolumeskincare.features.addshop.model.UpdateAddressShop
...
import com.breezebiolumeskincare.features.addshop.presentation.*
...
import com.breezebiolumeskincare.features.location.model.ShopDurationRequestData
...
import com.breezebiolumeskincare.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezebiolumeskincare.features.marketing.model.MarketingCategoryListResponse
...
import com.breezebiolumeskincare.features.nearbyshops.model.StageListResponseModel
...
import com.breezebiolumeskincare.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezebiolumeskincare.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezebiolumeskincareApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
