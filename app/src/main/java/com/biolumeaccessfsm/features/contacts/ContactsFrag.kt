...
import com.biolumeaccessfsm.app.domain.CallHisEntity
import com.biolumeaccessfsm.app.domain.CompanyMasterEntity
import com.biolumeaccessfsm.app.domain.ContactActivityEntity
import com.biolumeaccessfsm.app.domain.ShopActivityEntity
import com.biolumeaccessfsm.app.domain.SourceMasterEntity
import com.biolumeaccessfsm.app.domain.StatusMasterEntity
...
import com.biolumeaccessfsm.features.nearbyshops.presentation.AdapterCallLogL
import com.biolumeaccessfsm.features.nearbyshops.presentation.UpdateShopStatusDialog
...
class ContactsFrag : BaseFragment(), View.OnClickListener {
    ...
    override fun onClick(p0: View?) {
        when (p0?.id) {
            ...
            R.id.iv_click_scheduler->{
                    (mContext as DashboardActivity).loadFragment(FragType.SchedulerAddFrag, true, "")
            }
    ...
    fun showContactNameL(obj:ContactGr){
        ...
        doAsync {
            ...
            println("tag_cont selected gr ${obj.gr_name} fetch")
            uiThread {
                progress_wheel.stopSpinning()
                if(contactL.size>0){
