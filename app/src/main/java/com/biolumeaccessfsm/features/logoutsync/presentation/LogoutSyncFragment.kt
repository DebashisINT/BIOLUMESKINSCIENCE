package com.biolumeaccessfsm.features.logoutsync.presentation
...
import com.biolumeaccessfsm.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.biolumeaccessfsm.features.billing.api.AddBillingRepoProvider
import com.biolumeaccessfsm.features.billing.model.AddBillingInputParamsModel
...
import com.biolumeaccessfsm.features.dashboard.presentation.ReasonDialog
...
import com.biolumeaccessfsm.features.document.model.AddEditDocumentInputParams
import com.biolumeaccessfsm.features.document.model.DocumentAttachmentModel
...
import com.biolumeaccessfsm.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
...
import com.biolumeaccessfsm.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.biolumeaccessfsm.features.orderhistory.model.*
...
import com.biolumeaccessfsm.features.quotation.model.AddQuotInputModel
import com.biolumeaccessfsm.features.shopdetail.presentation.api.EditShopRepoProvider
import com.biolumeaccessfsm.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.biolumeaccessfsm.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.biolumeaccessfsm.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.biolumeaccessfsm.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.biolumeaccessfsm.features.timesheet.model.AddTimeSheetInputModel
import com.biolumeaccessfsm.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.biolumeaccessfsm.features.viewAllOrder.model.AddOrderInputParamsModel
import com.biolumeaccessfsm.features.viewAllOrder.model.AddOrderInputProductList
import com.biolumeaccessfsm.mappackage.SendBrod
import com.biolumeaccessfsm.widgets.AppCustomTextView
import com.biolumeaccessfsm.MonitorService
import com.biolumeaccessfsm.MySingleton
import com.biolumeaccessfsm.features.addshop.model.*
import com.biolumeaccessfsm.features.addshop.model.assigntopplist.AddShopUploadImg
import com.biolumeaccessfsm.features.addshop.presentation.ShopExtraContactReq
import com.biolumeaccessfsm.features.addshop.presentation.multiContactRequestData
...
import com.biolumeaccessfsm.features.login.model.GetConcurrentUserResponse
import com.biolumeaccessfsm.features.login.model.WhatsappApiData
import com.biolumeaccessfsm.features.performance.model.Gps_status_list
import com.biolumeaccessfsm.features.performance.model.UpdateGpsInputListParamsModel
import com.biolumeaccessfsm.features.returnsOrder.ReturnProductList
import com.biolumeaccessfsm.features.returnsOrder.ReturnRequest
import com.biolumeaccessfsm.features.viewAllOrder.model.NewOrderSaveApiModel
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbiolumeaccessfsmlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbiolumeaccessfsmlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbiolumeaccessfsmlogsample/log.zip").path);
