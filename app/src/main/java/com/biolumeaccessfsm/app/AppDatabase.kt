package com.biolumeaccessfsm.app
...
import com.biolumeaccessfsm.app.AppConstant.DBNAME
import com.biolumeaccessfsm.app.domain.*
import com.biolumeaccessfsm.features.lead.model.LeadActivityDao
import com.biolumeaccessfsm.features.lead.model.LeadActivityEntity
import com.biolumeaccessfsm.features.location.UserLocationDataDao
import com.biolumeaccessfsm.features.location.UserLocationDataEntity
import com.biolumeaccessfsm.features.login.*
import com.biolumeaccessfsm.features.taskManagement.model.TaskManagementDao
...
@Database(entities = arrayOf(AddShopDBModelEntity::class, UserLocationDataEntity::class, UserLoginDataEntity::class, ShopActivityEntity::class,
    ...
    ContactActivityEntity::class,ScheduleTemplateEntity::class,ModeTemplateEntity::class,RuleTemplateEntity::class),
